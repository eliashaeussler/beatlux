...
public class Database {
	...
	public static void CreateTables ()
	{
		// SQL statements
		string[] stm = {
			"CREATE TABLE IF NOT EXISTS `file` ( `id` INTEGER PRIMARY KEY AUTOINCREMENT, `path` TEXT NOT NULL UNIQUE, `artists` TEXT DEFAULT NULL, `album` TEXT DEFAULT NULL, `title` TEXT DEFAULT NULL )",
